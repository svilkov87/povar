                ...
                <form method="post" action="">
                    ...
                    <div class="block_settings_pass">
                        ...
                        <div class="wrapp_sett_pass">
                            ...
                            <input type="password" name="now_pass" class="name_sett_input" value="<?php echo @$data['now_pass']; ?>">
                        </div>
                        <div class="wrapp_sett_pass">
                            <span class="sett_pass_span">Новый пароль</span><br>
                            <input type="password" name="new_pass" class="name_sett_input" value="<?php echo @$data['new_pass']; ?>">
                        </div>
                        <div class="wrapp_sett_pass">
                            <span class="sett_pass_span">Повтор нового пароля</span><br>
                            <input type="password" name="e_new_pass" class="name_sett_input" value="<?php echo @$data['e_new_pass']; ?>">
                        </div>
                    </div>
