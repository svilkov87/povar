        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="theme_topic" >
                ...
                if ($us_id == $_SESSION['user_id']):?>
                    <div class="content_topic">
                        <a href="edit_topic.php?id=<?php echo $item['id'];?>" class="edit_topic_link">Редактировать</a>
                    </div>
                <?php  endif;?>
                <div class="author_of_fullart">
                    <?php foreach($auth as $item): ?>
                        <span class="name_auth">Автор:</span>
                        <a href="profile.php?id=<?php echo $item['id'];?>" class="name_auth"><?php echo $item['username'];?></a>
                    <?php endforeach; ?>
                    <br>
            ...
            <?php endforeach;?>
                ...
                <div class="full_art_forms">
                    ...
                    <form method="post" action="">
                        ...
                        <input readonly hidden type="text" name="input_theme" id="answer_input" value="<?php echo $topic_theme;?>">
                        <input readonly hidden type="text" name="input_user" id="answer_input" value="<?php echo $us_id;?>">
                        <input readonly hidden type="text" name="input_user_id" id="answer_input_to_user">
                        <textarea readonly hidden class="form-control" rows="3" name="answer_for_comment" id="answer_to_comment"></textarea>
                        <textarea class="form-control" rows="3" name="text" id="answer" placeholder="Введите сообшение..." onfocus="placeholder='';" onblur="placeholder='Введите сообшение...';"></textarea>
                ...
                <?php else:?>
                    <div class="no_comment_body">
                        <p class="no_comment_p">Комментарии могут оставлять только зарегистрированные или авторизованные пользователи</p>
                    </div>
                <?php endif;?>
                ...
                <div class="answers_panel">
                    ...
                    <div class="profile_link" role="answer_item_id" id="answer_item_id<?php echo $item['id'];?>">
                        ...
                        <div class="middle_content_comm">
                            ...
                            <a href="profile.php?id=<?php echo $item['user_id'];?>" class="p" id="answer_item_id<?php echo $item['id'];?>">
                                <?php echo $item['user_name'];?>
                            </a>
...
<!--                            <input type="text" name="input_theme" id="answer_input" value="--><?php //echo $topic_theme?><!--">-->
<!--                            <input type="text" name="input_user" id="answer_input" value="--><?php //echo $us_id;?><!--">-->
...
<!--                --><?php //foreach ($comments as $item): ?>
<!--                <div class="panel-heading" role="answer_item_id" id="answer_item_id--><?php //echo $item['id'];?><!--">-->
<!--                    <a href="#" id="hidden_id">--><?php //echo $item['id'];?><!--</a>-->
<!--                    <a href="#" id="hidden_id_to_user">--><?php //echo $item['user_id'];?><!--</a>-->
<!--                    <a href="#" id="hidden_text_to_comment">--><?php //echo $item['text'];?><!--</a>-->
<!--                    <a href="profile.php?id=--><?php //echo $item['user_id'];?><!--" class="p" id="answer_item_id--><?php //echo $item['id'];?><!--">-->
