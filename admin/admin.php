...
//Считаем общее количество статей админа cuckoo
$artCuckoo = $pdo->query('SELECT COUNT(*) FROM `article` WHERE main_id = 1')->fetchColumn();
...
<!--                            <th>автор</th>-->
                        ...
                        <?php foreach($article as $item): ?>
                            ...
                            <tr>
                                ...
                                <th><a href="../../full.php?id=<?php echo $item['id'];?>" style="color: #5a6271">
                                        <?php echo $item['title'];?>
                                    </a></th>
                                <th style="font-weight: normal"><?php echo $item['date'];?></th>
                                <th style="font-weight: normal;text-align: center;"><?php echo $item['watches'];?></th>
