...
//     $user_name = $_SESSION['user_name'];
    if(isset($_POST['enter_comment'])){
        ...
        $insert = $pdo->prepare("INSERT INTO `comments` SET text=:text, ava=:ava, article_id=:article_id, article_intro_image=:article_intro_image, to_comment=:to_comment, user_id=:user_id, user_id_art=:user_id_art, user_name=:user_name, to_user=:to_user, answer_for_comment=:answer_for_comment");
                                ...
                                <div class="full_art_forms">
                                    <div class="user_init_full">
                                        ...
                                        <form method="post" action="">
                                            ...
                                            <input readonly hidden type="text" name="article_intro_image" id="answer_input_image" value="<?php echo $image_var;?>">
