                ...
                <div class="reg_forms">
                    <form method="post" action="reg.php" class="form_of_reg">
                        ...
                        <p class="p_forms_reg">
                            ...
                            <input  type="text" name="username" id="username" class="reg_inputs" autocomplete="on" value="<?php echo @$data['username'];?>">
                        </p>
                        <p class="p_forms_reg">
                            <label for="login">Логин</label><br>
                            <input  type="text" name="login" id="login" class="reg_inputs" autocomplete="on" value="<?php echo @$data['login'];?>">
                        </p>
                        <p class="p_forms_reg">
                            <label for="email">Email</label><br>
                            <input  type="text" name="email" id="email" class="reg_inputs" value="<?php echo @$data['email'];?>">
                        </p>
                        <p class="p_forms_reg">
                            <label for="password">Пароль</label><br>
                            <input  type="password" name="password" id="password" class="reg_inputs" value="<?php echo @$data['password'];?>">
                        </p>
                        <p class="p_forms_reg">
                            <label for="e_password">Повторите пароль</label><br>
                            <input  type="password" name="e_password" id="e_password" class="reg_inputs" value="<?php echo @$data['e_password'];?>">
                        </p>
